...
- All executed Colabs (Google Drive): [Drive Folder](https://drive.google.com/drive/folders/1QYVnECDo6ncIeVdlBWT1ti1LFiy3rI6_?usp=sharing)

## Notebooks, Topics, and Video Walkthroughs

| # | Notebook | Topics | Video |
|---|---|---|---|
| 01 | [01_regularization_tensorflow.ipynb](notebooks/01_regularization_tensorflow.ipynb) | TF regularization: L1/L2, dropout, MC dropout, early stop, initializers, batch norm, callbacks, TensorBoard, Keras Tuner | [Video 1](https://youtu.be/-uuzYYW43eE) |
| 02 | [02_regularization_pytorch.ipynb](notebooks/02_regularization_pytorch.ipynb) | PyTorch parity of notebook 01 + Optuna + TensorBoard | [Video 2](https://youtu.be/l-SloYkmcZ8) |
| 03 | [03_kerascv_data_augmentation.ipynb](notebooks/03_kerascv_data_augmentation.ipynb) | KerasCV augmenters and policy-based augmentation on tf_flowers | [Video 3](https://youtu.be/pprWJ_uP4J0) |
| 04 | [04_augmentation_image_video_docimg.ipynb](notebooks/04_augmentation_image_video_docimg.ipynb) | AugLy for image/video, Augraphy for document images | [Video 4](https://youtu.be/ZQk6qTY2j10) |
| 05 | [05_augmentation_text_timeseries_tabular_speech.ipynb](notebooks/05_augmentation_text_timeseries_tabular_speech.ipynb) | Text, timeseries, tabular, and speech augmentation | [Video 5](https://youtu.be/YTLNAqNAGSE) |
| 06 | [06_keras_custom_training_components.ipynb](notebooks/06_keras_custom_training_components.ipynb) | One-cycle scheduler, MCAlphaDropout, MaxNormDense, TensorBoard | [Video 6](https://youtu.be/QozrxfcWSvU) |
| 07 | [07_keras_custom_loss_metrics_functions.ipynb](notebooks/07_keras_custom_loss_metrics_functions.ipynb) | Custom Huber loss/function family and custom metric | [Video 7](https://youtu.be/rH0UVHRHxR8) |
| 08 | [08_keras_custom_layers_and_model.ipynb](notebooks/08_keras_custom_layers_and_model.ipynb) | Custom layers and subclassed residual model | [Video 8](https://youtu.be/hnjsyntJMYg) |
| 09 | [09_keras_custom_optimizer_and_training_loop.ipynb](notebooks/09_keras_custom_optimizer_and_training_loop.ipynb) | Custom optimizer + GradientTape loop + tf.function speedup | [Video 9](https://youtu.be/U5n1u87fMfY) |
| 10 | [10_pytorch_advanced_and_wandb.ipynb](notebooks/10_pytorch_advanced_and_wandb.ipynb) | Advanced PyTorch custom constructs + W&B tracking | [Video 10](https://youtu.be/Y21jTBuvIqI) |
